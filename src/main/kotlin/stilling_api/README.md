...
Denne pakken bruker to endepunkter for å hente stillingsannonser fra NAV.
...
`main`-metoden i `StillingApi.kt` viser et konkret brukseksempel. Den søker
...
detaljene for det første treffet ut som et formatert sammendrag.
